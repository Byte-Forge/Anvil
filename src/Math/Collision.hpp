...
namespace hpse
{
	...
	public:
		...
		*/
		static bool CubeInFrustum(const std::array<std::array<float, 4>, 6>& frustum, glm::vec2& center, glm::vec2& size);
		...
		*/
		static int SphereInFrustum(const std::array<std::array<float, 4>, 6>& frustum, glm::vec2& center, float radius);
