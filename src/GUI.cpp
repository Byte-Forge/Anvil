...
GUI::GUI(GLFWwindow* window) : m_core(nullptr),m_window(window), m_frameTick(1)
{
	...
	m_increase_brush_button->SetBorderRadius(25);
	...
	m_increase_brush_height_button->SetBorderRadius(25);
	...
	m_decrease_brush_height_button->SetBorderRadius(25);
	...
	m_terrain_mode_button->SetBorderRadius(25);
	...
	m_texture_mode_button->SetBorderRadius(25);
	...
	m_entity_mode_button->SetBorderRadius(25);
